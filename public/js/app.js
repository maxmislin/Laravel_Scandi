...
__webpack_require__(/*! ./type-switcher */ "./resources/js/type-switcher.js");
...
function createForm(sel) {
  categories.forEach(function (element) {
    if (element.name == sel) atributes.forEach(function (el) {
      if (element.id == el.category_id) Change(element.name, el.aName, el.units);
    });
  });
}
...
function Change(name, aName, units) {
  ...
  if (units !== null) p.innerHTML = "Please, enter " + aName + " in " + units;else p.innerHTML = "Please, enter " + aName;
...
__webpack_require__(/*! /home/rmz/laravel-app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/rmz/laravel-app/resources/sass/app.scss */"./resources/sass/app.scss");
