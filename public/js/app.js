...
var switcher = document.getElementById("switcher"); //console.log(my_var1);
//console.log(my_var2);
...
function createForm(sel) {
  my_var1.forEach(function (element) {
    if (element.name == sel) my_var2.forEach(function (el) {
      if (element.id == el.category_id) Change(element.name, el.aName);
    });
  });
}
